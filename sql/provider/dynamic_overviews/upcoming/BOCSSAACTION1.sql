select '<div class="boc-todo-row row">
  ...
  <a href="censsacmpprofile.display_profile?p_profile_ty=PROVIDER_PROFILE&p_cust_id='  || :cust_id || '">
...
select '<div class="boc-todo-row row">
  <div class="col s10">
  <div class="boc-todo-action">
  <a href="ssaapexmnucall?p_app_id=BETASSA&p_page_id=53015&p_clearcache=53015&p_itemnames=P53015_PROVIDER_ID&p_itemvalues=' || :cust_id || '">
  Verify CE Program Info
  </a>
  </div>
  <div class="boc-todo-date">
  </div>
