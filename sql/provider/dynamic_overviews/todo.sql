...
union
select '<td style="width: 110px; text-align: center; vertical-align: top;"><a href="censsaindprofile.display_profile?p_profile_ty=INDIVIDUAL_PROFILE&p_cust_id=' || :cust_id || '" target="_self" title="Update Profile"><img alt="Profile" src="/images/My_Images/verify-my-contact-info.svg" border="0"></a></td>', 2
from dual
...
union
select '<td style="width: 110px; text-align: center; vertical-align: top;"><a href="ssaapexmnucall?p_app_id=BOCSSA&p_page_id=2505&p_cust_id=' || :cust_id || '" target="_self" title="Provider Link"><img alt="Provider Link" src="/images/My_Images/link-myself-to-a-provider-account.svg" border="0"></a></td>', 3
from dual
where not exists
